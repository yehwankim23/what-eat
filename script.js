const places = [
  [
    ...
    ["교대이층집", "http://naver.me/G3JErS7J", "고기", "C동 2층"],
    ...
    ["로다닭", "http://naver.me/GVMlO69F", "치킨", "B동 1층"],
    ["만석장", "http://naver.me/xNdjuynV", "두부", "C동 B1/B2층"],
  ...
  [
    ...
    ["마라공방", "http://naver.me/5Am4NJVp", "마라탕", "A동 별관"],
    ["샤오바오우육면", "http://naver.me/xpYs2B91", "우육면", "C동 B2층"],
    ["화화쿵주마라탕", "http://naver.me/501J1IW5", "마라탕", "C동 1층"],
  ],
  [
    ["겐텐", "http://naver.me/xKQWZR5e", "라멘", "B동 B3층"],
    ["나폴리수산", "http://naver.me/5kLXKKNq", "초밥", "C동 1층"],
    ["스시로", "http://naver.me/IxDkCrF6", "초밥", "B동 B3층"],
    ["아비꼬", "http://naver.me/xaPf6Exc", "카레", "C동 B2층"],
    ["아오리의행방불명", "http://naver.me/I5Fcamg9", "라멘", "C동 1층"],
    ["저스트텐동", "http://naver.me/GcjWAG8t", "텐동", "A동 별관"],
    ["코코로벤또", "http://naver.me/FBwoW2qO", "벤또", "B동 B3층"],
    ["홍대돈부리", "http://naver.me/5zJyJx0V", "돈부리", "C동 B2층"],
  ...
  [
    ...
    ["아일랜드", "http://naver.me/FDQs1Hk6", "스테이크", "B동 B3층"],
